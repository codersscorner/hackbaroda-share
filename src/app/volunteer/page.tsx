...
const SHARE_TEXT = `Excited to share that I, {LEADER}, am volunteering at HackBaroda 2026 🚀

Proud to be part of Gujarat's Largest Hackathon and contribute to an amazing community of builders, innovators, and developers ⚡

Big thanks to @Coders Corner, @Harsh Soni, and @Mann Dosi for organizing this incredible event 💻

See you in Vadodara on 7th June!

#HackBaroda2026 #CodersCorner #Volunteer #Hackathon #Innovation`;
...
export default function Page() {
  ...
  const getShareText = () =>
    SHARE_TEXT.replace("{LEADER}", leader || "name");
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-xl mx-auto px-4 pb-20">
          ...
          <section className="text-center pt-12 pb-8">
            ...
            >
              Proud Volunteer<br />of HackBaroda 2026
            </h1>
            ...
            <div className="bg-[rgba(255,252,240,0.92)] border border-[#d9c49a] rounded-xl p-6 shadow-md">
              <div className="grid grid-cols-1 gap-4 mb-5">
                <label className="flex flex-col gap-2">
                  <span className="text-[#b8860b] text-[9px] tracking-[3px] uppercase font-sans">Volunteer Name</span>
                  <input
                    value={leader}
                ...
                <label className="flex flex-col gap-2 cursor-pointer">
                  <span className="text-[#b8860b] text-[9px] tracking-[3px] uppercase font-sans">Volunteer Photo</span>
                  <div
          ...
          <section className="bg-[rgba(255,252,240,0.92)] border border-[#d9c49a] rounded-xl p-6 shadow-md mb-8">
            <div className="inline-flex items-center border-t border-b border-[#b8860b] py-1 px-4 mb-4">
              <span className="text-[#b8860b] text-[9px] tracking-[3px] uppercase font-sans">Share Your Volunteer Journey</span>
            </div>
